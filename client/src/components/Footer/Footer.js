        ...
        <div className='card bg-white mx-5'>
          <div className='row mb-4'>
            <div className='col-md-4 col-sm-4 col-xs-4'>
              <div className='footer-text pull-left'>
                <div className='d-flex'>
                  <h1 className='font-weight-bold text-black'> Top </h1>
                  <h1 id='custom-gc'>Group Construction</h1>
                </div>
                ...
                <span id='social-follow-text'>Follow us on social media:</span>

                <a href='https://www.youtube.com/@poldosreno2014'>
                  <svg
                ...
                <a href='https://www.instagram.com/tgc.topgroupconstruction/'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='16'
                    height='16'
            ...
            <div className='col-md-2 col-sm-2 col-xs-2'>
              ...
              <p className='footer-text-color'>Home Renovation</p>
              <p className='footer-text-color'>Plumbing</p>
              <p className='footer-text-color'>Carpentry</p>
            </div>
          ...
          <div className='row'>
            <div className='col-md-6 col-sm-6 col-xs-6'>
              <div className='pull-left'>
                <p className='footer-text-color'>Copyright 2023 TGC</p>
              </div>
            </div>
            <div className='col-md-6 col-sm-6 col-xs-6'>
              <div className='justify-content-end mr-4 d-flex policy'>
                <div className='footer-text-color'>Privacy Policy</div>
              </div>
            </div>
          </div>
        </div>
